...
let referenceBinaries = [ "FSharpNowinNancy.dll" ]
// Web site location for the generated documentation
let website = "/FSharpNowinNancy"

let githubLink = "http://github.com/TheAngryByrd/FSharpNowinNancy"

// Specify more information about your project
let info =
  [ "project-name", "FSharpNowinNancy"
    "project-author", "Jimmy Byrd"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharpNowinNancy" ]
